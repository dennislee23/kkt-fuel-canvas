...
window.FUEL_BLOCKS = [
  {
    ...
    "spine": "Закупка топлива — первое решение, от которого зависит вся экономика сети: что купить, в каком объёме, когда и у кого. Ошибка здесь тянется дальше по всей цепочке — дефицитом, излишком, замороженным капиталом и переплатой. Мы превращаем закупку из решения по опыту и доступности — в решение по данным: прогноз спроса, выгодный объём и момент, честное сравнение поставщиков и полная стоимость партии. Эффект — топливо закуплено вовремя и в нужном объёме, по лучшей доступной цене и с меньшим замороженным капиталом."
  },
  {
    "id": "b-logistics",
    "code": "B",
    ...
    "spine": "После того как топливо закуплено, оно проходит через руки, которыми сеть не управляет: железную дорогу, таможню, порт, перевозчика. Здесь задача — не потерять контроль и деньги на чужом этапе: видеть, где партия и что с ней, ловить демередж и штрафы до того, как они стали счётом, и упростить приёмку и раскредитовку. А во внутренней доставке от базы до станции — превратить ручную разнарядку и маршрутизацию в просчитанные и контролируемые. Эффект — меньше штрафов и простоев на внешнем плече, прозрачная приёмка, и топливо доезжает до станций по выполнимому плану, а не в режиме тушения пожара."
  },
  {
    ...
    "spine": "Станция приносит деньги двумя путями — топливом на колонке и магазином с кафе, где он есть, — и результат каждой зависит от того, насколько чётко ею управляют в моменте. Многое уходит незаметно: недолив и махинации на ТРК, очередь, из-за которой клиент уезжает, трафик, что не доходит до магазина, списания и пустые полки. Мы делаем работу станции видимой и управляемой по каждой точке — в моменте, а не в отчёте постфактум. Эффект — меньше операционных потерь и выше выручка там, где её недобирали."
  },
  {
    ...
    "spine": "Транзакционная база есть у каждой сети — вопрос в том, работает ли она на выручку или просто копится. Мы превращаем лояльность из раздачи скидок всем подряд — в адресную работу: кто приносит прибыль, кто уходит, кого вернуть и кому предложить, чтобы он заехал и купил. Эффект — выше удержание и средний чек, меньше скидок впустую, и программа лояльности как инструмент роста, а не статья затрат."
  },
  {
    ...
    "spine": "В топливе деньги движутся быстро, маржа тонкая, а правда о финансах часто собирается вручную и с опозданием. Мы превращаем финансовую картину из отчёта к утру — в живую: спросить цифры словами, понять причину отклонения, увидеть кассовый разрыв заранее и поймать утечку до того, как она ушла. Эффект — быстрее решения, меньше замороженного и потерянного, и финансам можно верить."
  },
  {
    ...
    "spine": "Поддерживающие функции — HR, юристы, закупки, контроль — держатся на ручной рутине там, где давно работала бы автоматика. Мы снимаем механическую часть: разобрать резюме, найти ответ в регламентах, подготовить документ, увидеть, где переплатили и где обходят правила. Эффект — команда занимается решениями, а не перекладыванием бумаг, и нарушения видны до аудита, а не после."
  },
  {
    ...
    "spine": "Всё, что выше — прогнозы, оптимизация, агенты — работает ровно настолько, насколько надёжны данные под ними. Мы выстраиваем основу, на которой держится остальное: одна правда вместо разных цифр в отделах, данные в одном месте, и рабочие ИИ-инструменты, доступные команде с первого дня. Эффект — на этот фундамент встаёт всё остальное, а быстрые победы команда получает сразу, пока он строится."
  }
];
...
window.FUEL_CARDS = [
  ...
  },
  {
    ...
    "scale": "Scoped Project",
    "impact": "Сокращение затрат",
    "lock": "полная стоимость партии считается (A3 Essential)",
    "flowsTo": []
  },
  ...
  },
  {
    ...
    "scale": "Scoped Project",
    "impact": "Рост выручки",
    "lock": "свою цену против конкурентов видно (A4 Essential)",
  ...
  },
  {
    ...
    "scale": "Scoped Project",
    "impact": "Сокращение затрат",
    "lock": "статус поставок виден (B1.1 Essential)",
    "sequence": 2,
    "flowsTo": []
  },
  {
  ...
  },
  {
    ...
    "scale": "Scoped Project",
    "impact": "Сокращение затрат",
    "lock": "сверка приёмки налажена (B1.2 Essential) + история поставок",
    "sequence": 2,
    "flowsTo": []
  },
  {
  ...
  },
  {
    ...
    "scale": "Scoped Project",
    "impact": "Сокращение затрат",
    "lock": "статус вагонов и простоев виден (B1.3 Essential)",
    "sequence": 2,
    "flowsTo": []
  },
  {
  ...
  },
  {
    ...
    "scale": "Scoped Project",
    "impact": "Сокращение затрат",
    "lock": "сверка слива-налива налажена (B2.1 Essential) + история",
    "sequence": 2,
    "flowsTo": []
  },
  {
  ...
  },
  {
    ...
    "scale": "Scoped Project",
    "impact": "Сокращение затрат",
    "lock": "контроль качества налажен (B2.2 Essential)",
    "sequence": 2,
    "flowsTo": []
  },
  {
  ...
  },
  {
    ...
    "scale": "Scoped Project",
    "impact": "Скорость и качество решений",
    "lock": "сравнение станций налажено (C1.1 Essential)",
    "flowsTo": [
      "c1-1-station-analysis-agent"
    ]
  },
  ...
  },
  {
    ...
    "scale": "Scoped Project",
    "impact": "Рост выручки",
    "lock": "данные трафика собираются (C1.2 Essential)",
    "flowsTo": []
  },
  {
  ...
  },
  {
    ...
    "scale": "Scoped Project",
    "impact": "Сокращение затрат",
    "lock": "данные оборудования + история отказов",
    "flowsTo": []
  },
  {
  ...
  },
  {
    ...
    "scale": "Scoped Project",
    "impact": "Рост выручки",
    "lock": "продажи по станции видны (C2.2 Essential)",
    "flowsTo": []
  },
  {
  ...
  },
  {
    ...
    "scale": "Scoped Project",
    "impact": "Сокращение затрат",
    "lock": "контроль стока и списаний налажен (C2.3 Essential)",
    "flowsTo": []
  },
  {
  ...
  /* D — Customers & Loyalty */
    ...
    },
    {
      ...
      "scale": "Scoped Project",
      "impact": "Рост выручки",
      "lock": "профиль клиента 360 + история покупок",
      "flowsTo": []
    },
    {
    ...
    },
    {
      ...
      "scale": "Scoped Project",
      "impact": "Рост выручки",
      "lock": "профиль клиента 360 + история поведения",
      "flowsTo": [
        "d1-2-retention-action",
    ...
    },
    {
      ...
      "scale": "Major Program",
      "impact": "Повышение производительности",
      "lock": "база знаний и регламенты + история обращений",
      "flowsTo": []
    },
  ...
  },
  {
    ...
    "scale": "Scoped Project",
    "impact": "Скорость и качество решений",
    "lock": "отклонения от плана видны (E2 Essential) + единая основа",
    "flowsTo": [
      "e-frontier-finops-agent"
    ]
  },
  ...
  },
  {
    ...
    "scale": "Scoped Project",
    "impact": "Скорость и качество решений",
    "lock": "картина кэша собрана (E3 Essential) + единая основа",
    "flowsTo": [
      "e-frontier-finops-agent"
    ]
  },
  {
    ...
    "scale": "Scoped Project",
    "impact": "Сокращение затрат",
    "lock": "картина дебиторки и платежей + история",
    "flowsTo": []
  },
  {
  ...
  /* F — Support Functions — CARDS */
  {
    ...
    "stage": 1, "sequence": 1, "cost": "$", "scale": "Quick Win",
  ...
  },
  {
    ...
    "stage": 1, "sequence": 1, "cost": "$$", "scale": "Scoped Project",
  ...
  },
  {
    ...
    "stage": 1, "sequence": 1, "cost": "$$$", "scale": "Major Program",
  ...
  },
  {
    ...
    "stage": 2, "sequence": 1, "cost": "$$$", "scale": "Scoped Project",
    "impact": "Сокращение затрат",
  ...
  },
  {
    ...
    "stage": 3, "sequence": 1, "cost": "$$$$", "scale": "Major Program",
    "impact": "Скорость и качество решений",
  ...
  },
  {
    ...
    "stage": 2, "sequence": 2, "cost": "$$$", "scale": "Scoped Project",
    "impact": "Скорость и качество решений",
    "lock": "видимость закупок МТО (F3.1)", "flowsTo": []
  },
  {
    ...
    "stage": 2, "sequence": 5, "cost": "$$$", "scale": "Scoped Project",
    "impact": "Сокращение затрат",
