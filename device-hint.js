...
(function () {
  ...
  function init() {
    ...
    // (fuel or retail key), falls back to EN.
    var _lang = 'EN';
    try { _lang = localStorage.getItem('kkt-fuel-lang') || localStorage.getItem('kkt-retail-lang') || 'EN'; } catch (e) {}
    var T = {
      ...
      DE: { h:'Drehen Sie Ihr Telefon', p:'Die Karte ist für einen breiten Bildschirm gebaut. Drehen Sie Ihr Telefon ins Querformat — oder öffnen Sie sie besser auf einem Computer oder Tablet.', go:'Trotzdem fortfahren', b:'<strong>Besser auf einem großen Bildschirm.</strong> Die Karte ist für Computer oder Tablet gebaut.' },
    };
    var t = T[_lang] || T.EN;
