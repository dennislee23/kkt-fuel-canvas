...
out.push('');
out.push('The Fuel AI Transformation Map is a working artifact from KKT, a data, AI, and automation delivery firm based in Tallinn, Estonia (EU). KKT\'s marquee fuel deployment is Optimus — a procurement-and-margin engine in pilot at Red Petroleum, a 250-station independent fuel network in Kyrgyzstan. The map below shows where Optimus sits within the broader network economy and what else becomes possible once connected data and control are in place.');
out.push('');
