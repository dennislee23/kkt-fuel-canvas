<?php
/**
 * Self-deploy script for fuelretail.kittykat.tech.
 *
 ...
 *   4. Visit https://fuelretail.kittykat.tech/update.html to push updates.
 */
...
if ($mode !== 'status') {
    ...
    foreach (['index.html', 'advisor.js', 'api/advisor.php'] as $f) {
